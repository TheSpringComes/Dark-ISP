...
test_pipeline = [
    ...
    dict(
        ...
        bayer_substitute = '/public/home/guojs/data/NOD/Sony_RGB/'
        )
]
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/Sony/npz_new_Sony_RX100m7_val.json',
        data_prefix=dict(img='Sony_npz/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/Sony/npz_new_Sony_RX100m7_val.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'annotations/Sony/npz_new_Sony_RX100m7_test.json',
        data_prefix=dict(img='Sony_npz/'),
        test_mode=True,
        pipeline=test_pipeline))
test_evaluator = dict(
