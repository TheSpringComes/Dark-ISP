...
model = dict(
    ...
    bbox_head=dict(
        type='RetinaHead',
        num_classes=80,  # 8 classes in COCO
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
...
test_pipeline = [
    ...
    dict(
        ...
        bayer_substitute = '/home/jing/datasets/COCO/val2017_SynRAW/',
        suffix = '.jpg')
]
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations_trainval2017/annotations/instances_train2017_npz.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations_trainval2017/annotations/instances_val2017_npz.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations_trainval2017/annotations/instances_val2017_npz.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
