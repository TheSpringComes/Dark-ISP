...
data_root = '/home/jing/datasets/LOD_BMVC2021/LOD_BMVC2021forDarkISP'
        ...
        dataset=dict(
            ...
            datasets=[
                dict(
                    ...
                    img_subdir = 'RAW_dark_npz',
                    ann_subdir = 'RGB-dark-Annotations',
                ...
                #     data_prefix=dict(img='RAW_dark_npz/'),
